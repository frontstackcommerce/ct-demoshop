...
export interface paths {
  ...
  "/listing/super/search": {
    /**
     * Fetch SuperSearch
     * @description Fetch SuperSearch
     */
    post: operations["getSuperSearchBlock"];
    parameters: {
      header?: {
        "fs-request-url"?: components["parameters"]["FsRequestUrl"];
      };
  ...
  "/listing/variant/search": {
    /**
     * Fetch VariantSearch
     * @description Fetch VariantSearch
     */
    post: operations["getVariantSearchBlock"];
    parameters: {
      header?: {
        "fs-request-url"?: components["parameters"]["FsRequestUrl"];
      };
...
export interface components {
  schemas: {
    ...
    ProductCard: {
      bopis?: components["schemas"]["Boolean"];
      ...
      sale?: components["schemas"]["Boolean"];
    ...
    /** @description Available query options (filters and sortings) for SuperSearch blocks */
    SuperSearchQueryOptions: {
      /** @description Sort options for SuperSearch blocks */
      sort: {
        brand: components["schemas"]["String"];
        name: components["schemas"]["String"];
        "price.amount": components["schemas"]["Price"]["amount"];
      };
      /** @description Filter options for SuperSearch blocks */
      filter: {
        brand: components["schemas"]["String"];
        "options.": components["schemas"]["String"];
        "options.color-code": components["schemas"]["String"];
    ...
    /** @description Available query options (filters and sortings) for VariantSearch blocks */
    VariantSearchQueryOptions: {
      /** @description Sort options for VariantSearch blocks */
      sort: Record<string, never>;
      /** @description Filter options for VariantSearch blocks */
      filter: Record<string, never>;
    };
...
export interface operations {
  ...
  getSuperSearchBlock: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["SuperSearch"];
        };
      };
      /** @description Not Found */
      404: {
  ...
  getVariantSearchBlock: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["VariantSearch"];
        };
      };
      /** @description Not Found */
      404: {
